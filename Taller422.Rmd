...
|                  |  `library(paqueteDEG)`                                  |
|                  | **tamaño de muestra**                                   |
|    $\mu$         | `paqueteDEG::sizemu(1.96,345,2)     # sizemu(z,sigma2,error)`|
|    $p$           | `paqueteDEG::sizep(1.96,0.5,0.05)   # sizep(z,prob,error)`   |
|   $n_{aj}$      | `paqueteDEG::adjusted_size(385,2000) # adjusted_size(n,N)`   |
